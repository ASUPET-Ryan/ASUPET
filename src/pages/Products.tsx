          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {principles.map((principle, index) => {
              ...
              return (
                <div
                  key={index}
                  className="card-cute text-center p-8 group"
                >
                  <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-primary-500 to-secondary-500 rounded-cute mb-6 shadow-cute group-hover:shadow-glow transition-all duration-300 transform group-hover:scale-110">
                    <Icon className="w-10 h-10 text-white" />
                  </div>
                  <h3 className="subheading-cute">
                    {principle.title}
                  </h3>
